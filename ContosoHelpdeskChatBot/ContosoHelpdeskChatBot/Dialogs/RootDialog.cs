namespace ContosoHelpdeskChatBot.Dialogs
{
    ...
    public class RootDialog : ComponentDialog
    {
        ...
        {
            new Choice(InstallAppOption) { Synonyms = new List<string> { "Install Application", "install" } },
            new Choice(ResetPasswordOption) { Synonyms = new List<string> { "Reset Password", "password" } },
            new Choice(LocalAdminOption) { Synonyms = new List<string> { "Request Local Admin", "admin" } },
        };
